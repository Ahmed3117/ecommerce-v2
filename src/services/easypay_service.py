...
class EasyPayService:
    def __init__(self):
        ...
        self.vendor_code = getattr(settings, 'EASYPAY_VENDOR_CODE', 'easytech_73497801958412')
        self.secret_key = getattr(settings, 'EASYPAY_SECRET_KEY', 'aa093225-cb06-4b39-b684-1f8533c5e2f6')
